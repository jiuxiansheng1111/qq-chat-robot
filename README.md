...
- 每天可从发言超过 5 条的群友中随机产生一名“今日夺舍”娱乐角色。
...
| `@机器人 今日夺舍` | 所有人 | 查看/产生今日娱乐角色，候选人需当天发言超过 5 条 |
| `@机器人 夺舍状态` | 所有人 | 查看今天是否正在夺舍以及抽中的真实群名片 |
| `@机器人 退出夺舍` | 被抽中者/管理员 | 结束今天的夺舍，第二天自动恢复 |
...
- “今日夺舍”使用候选人真实的群名片（没有群名片时使用 QQ 昵称）。机器人会以该名字自我介绍，但始终标注为娱乐扮演，不会声称自己是真人或代表该成员。
- 当天被抽中的成员或群管理员可发送 `@机器人 退出夺舍`；退出后当天不会重新抽取，第二天自动恢复。
