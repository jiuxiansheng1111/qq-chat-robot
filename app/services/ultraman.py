...
_ENCYCLOPEDIA_IMAGE_ALIASES = {
    "迪迦奥特曼·强力型": ("迪迦强力型", "迪迦·强力型", "Tiga Power Type"),
    "迪迦奥特曼·空中型": ("迪迦空中型", "迪迦·空中型", "Tiga Sky Type"),
    "闪耀迪迦": ("闪耀迪迦（TV版）", "闪耀迪迦（剧场版）", "闪光迪迦", "黄金迪迦"),
    "戴拿奥特曼·强壮型": ("戴拿强壮型", "戴拿·强壮型", "Dyna Strong Type"),
    "戴拿奥特曼·奇迹型": ("戴拿奇迹型", "戴拿·奇迹型", "Dyna Miracle Type"),
    "盖亚奥特曼V2": ("盖亚V2", "盖亚V2型", "Gaia V2"),
    "盖亚奥特曼·至高型": ("盖亚至高型", "盖亚至高形态", "Gaia Supreme Version"),
    "阿古茹奥特曼V2": ("阿古茹V2", "阿古茹V2型", "Agul V2"),
    "高斯奥特曼·日冕模式": ("高斯日冕形态", "高斯日冕模式", "Cosmos Corona Mode"),
    "高斯奥特曼·日蚀模式": ("高斯日蚀形态", "高斯日蚀模式", "Cosmos Eclipse Mode"),
    "奈克瑟斯奥特曼·青年形态": (
        "奈克瑟斯青年型",
        "奈克赛斯青年型",
        "奈克瑟斯青年形态",
    ...
    "梦比优斯奥特曼·勇者形态": ("梦比优斯勇者", "梦比优斯勇者形态", "Mebius Brave"),
    "梦比优斯奥特曼·燃烧勇者": (
        "梦比优斯燃烧勇者",
        "梦比优斯燃烧勇者形态",
    ...
    "梦比优斯奥特曼·无限形态": ("梦比优斯无限形态", "Mebius Infinity"),
    "超级奥特曼泰罗": ("超级泰罗", "超级奥特曼泰罗", "Super Ultraman Taro"),
    "赛罗奥特曼·强壮日冕型": ("强壮日冕型赛罗", "强壮日冕赛罗", "Strong Corona Zero"),
    "赛罗奥特曼·月神奇迹型": ("月神奇迹型赛罗", "月神奇迹赛罗", "Luna Miracle Zero"),
    "赛罗奥特曼·闪耀型": (
        "光辉赛罗",
        "闪耀赛罗",
        "赛罗奥特曼光辉形态",
    ...
    "银河维克特利奥特曼": ("银河维克特利", "Ginga Victory"),
    "维克特利骑士": ("维克特利骑士形态", "Victory Knight"),
    "艾克斯奥特曼·超越形态": ("艾克斯超越型", "超越X", "Exceed X"),
    "欧布奥特曼·重光形态": ("斯佩修姆哉佩利敖", "欧布重光形态", "Specium Zeperion"),
    "欧布奥特曼·暴炎形态": ("燃烧炸弹", "欧布暴炎形态", "Burnmite"),
    "欧布奥特曼·疾风形态": ("飓风切割", "欧布疾风形态", "Hurricane Slash"),
    "欧布奥特曼·暗耀形态": ("雷霆胸章", "欧布暗耀形态", "Thunder Breastar"),
    "欧布奥特曼·原生形态": ("欧布起源", "欧布原生", "Orb Origin"),
    "欧布奥特曼·煌闪形态": ("闪电攻击者", "欧布煌闪形态", "Lightning Attacker"),
    "欧布奥特曼·智勇形态": ("艾梅利姆头镖", "欧布智勇形态", "Emerium Slugger"),
    "捷德奥特曼·原始形态": ("捷德原始形态", "Geed Primitive"),
    "捷德奥特曼·尊皇形态": (
        "捷德尊皇形态",
        "皇家超级大师",
        "皇家大师",
    ...
    "泰迦奥特曼·光子地球": ("泰迦奥特曼光子地球", "泰迦光子地球", "Taiga Photon Earth"),
    "泰迦奥特曼·三重斯特利姆形态": (
        "泰迦奥特曼三重斯特利姆",
        "泰迦三重斯特利姆",
        "Taiga Tri-Strium",
    ),
    "闪耀特利迦永恒": ("永恒闪耀特利迦", "闪耀特利迦永恒", "Glitter Trigger Eternity"),
    "真理特利迦": ("真特利迦", "特利迦真理形态", "Trigger Truth"),
    "德凯奥特曼·强劲型": ("德凯强劲型", "德凯奥特曼强劲型", "Decker Dynamic Type"),
    "布莱泽奥特曼·法多兰盔甲": (
        "布莱泽法德兰装甲",
        "布莱泽法多兰盔甲",
        "Blazar Firdran Armor",
    ),
    "亚刻奥特曼·银河装甲": ("亚刻奥特曼银河装甲", "亚刻银河装甲", "Arc Galaxy Armor"),
}
