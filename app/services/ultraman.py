...
_FORM_VARIANTS = (
    ...
    ("欧米伽奥特曼·雷金斯装甲", "ultraman-omega", 2025, "借助陨星怪兽雷基尼斯力量形成的电视强化装甲，配合雷基尼斯巨剑与念动力作战。", "在《欧米伽奥特曼》TV正剧中，雷基尼斯与欧米伽共鸣并化作装甲与武器。"),
    ("欧米伽奥特曼·特里加隆装甲", "ultraman-omega", 2025, "借助陨星怪兽特里加隆力量形成的高速近战装甲，以利爪和高机动性压制敌人。", "在《欧米伽奥特曼》TV正剧中，特里加隆与欧米伽共鸣后化作装甲与利爪。"),
    ("欧米伽奥特曼·瓦尔根斯装甲", "ultraman-omega", 2025, "借助陨星怪兽瓦尔格尼斯力量形成的元素型装甲，能够利用火、水、风、地等自然力量。", "在《欧米伽奥特曼》TV正剧后半段登场，瓦尔格尼斯化作装甲与长柄武装支援欧米伽。"),
    ("欧米伽奥特曼·加梅顿装甲", "ultraman-omega", 2026, "借助盖梅顿力量形成的新装甲形态。", "在2026年TV节目《奥特曼新生代之星》中作为欧米伽的新装甲登场。"),
)
