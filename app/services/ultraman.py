...
_ENCYCLOPEDIA_IMAGE_ALIASES = {
    ...
    "盖亚奥特曼V2": ("盖亚奥特曼V2型", "盖亚V2", "盖亚V2型"),
    "盖亚奥特曼·至高型": ("盖亚奥特曼至高型", "盖亚至高型", "盖亚至尊型"),
    "高斯奥特曼·日冕模式": ("高斯奥特曼日冕模式", "高斯日冕模式", "高斯日冕型"),
    "高斯奥特曼·日蚀模式": ("高斯奥特曼日蚀模式", "高斯日蚀模式", "高斯日蚀型"),
    "奈克瑟斯奥特曼·青年形态": ("奈克瑟斯青年型", "奈克瑟斯青年形态"),
    "奈克瑟斯奥特曼·青年蓝色形态": (
        "奈克瑟斯青年蓝色形态",
        "奈克瑟斯青年蓝色型",
        "奈克瑟斯蓝色青年型",
    ),
    "梦比优斯奥特曼·勇者形态": ("梦比优斯勇者形态", "梦比优斯勇者"),
    "梦比优斯奥特曼·燃烧勇者": (
        "梦比优斯燃烧勇者形态",
        "梦比优斯燃烧勇者",
        "梦比优斯炽热勇气形态",
    ),
    "梦比优斯奥特曼·凤凰勇者": ("梦比优斯凤凰勇者形态", "梦比优斯凤凰形态"),
    "超级奥特曼泰罗": ("超级泰罗", "超级奥特曼泰罗"),
    "赛罗奥特曼·强壮日冕型": ("赛罗强壮日冕型", "强壮日冕赛罗"),
    "赛罗奥特曼·月神奇迹型": ("赛罗月神奇迹型", "月神奇迹赛罗"),
    "赛罗奥特曼·闪耀型": ("闪耀赛罗", "赛罗闪耀形态"),
    "维克特利骑士": ("骑士维克特利", "维克特利骑士形态"),
    "艾克斯奥特曼·超越形态": ("艾克斯超越型", "超越X", "超限艾克斯"),
    "捷德奥特曼·原始形态": ("捷德原始形态", "捷德奥特曼原始形态"),
    "捷德奥特曼·刚燃形态": ("捷德刚燃形态", "坚固燃烧", "捷德坚固燃烧"),
    "捷德奥特曼·机敏形态": ("捷德机敏形态", "交叉粉碎", "交叉重击"),
    "捷德奥特曼·豪勇形态": ("捷德豪勇形态", "捷德奥特曼豪勇形态"),
    "捷德奥特曼·尊皇形态": ("尊皇形态", "皇家超级大师", "皇家大师"),
    "捷德奥特曼·银河初升": ("银河初升", "银河升华", "银河升华形态"),
    "泰迦奥特曼·光子地球": ("泰迦光子地球", "光子地球形态"),
    "泰迦奥特曼·三重斯特利姆形态": (
        "泰迦三重斯特利姆",
        "三重斯特利姆形态",
        "三重斯特利姆",
    ),
    "闪耀特利迦永恒": ("特利迦闪耀永恒", "闪耀永恒特利迦", "永恒闪耀特利迦"),
    "真理特利迦": ("特利迦真理形态", "真理特利迦形态"),
    "德凯奥特曼·强劲型": ("德凯强劲型", "德凯动态型", "德凯奥特曼动态型"),
    "布莱泽奥特曼·法多兰盔甲": (
        "布莱泽法德兰装甲",
        "布莱泽法多兰装甲",
        "法德兰装甲形态",
    ),
    "亚刻奥特曼·银河装甲": ("亚刻银河装甲", "亚刻星河装甲", "星河装甲形态"),
}
