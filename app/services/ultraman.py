...
_ULTRAMAN_ALIASES = {
    ...
    "欧布智勇形态": "欧布奥特曼·闪电攻击者",
    "闪电攻击者": "欧布奥特曼·闪电攻击者",
    "欧布艾梅利姆头镖": "欧布奥特曼·艾梅利姆头镖",
    "艾梅利姆头镖": "欧布奥特曼·艾梅利姆头镖",
    "欧布雷霆肩章": "欧布奥特曼·暗耀形态",
    "欧布雷霆胸章": "欧布奥特曼·暗耀形态",
    "雷霆胸章": "欧布奥特曼·暗耀形态",
    "雷霆肩章": "欧布奥特曼·暗耀形态",
    "ThunderBreastar": "欧布奥特曼·暗耀形态",
    "サンダーブレスター": "欧布奥特曼·暗耀形态",
    "欧布暗耀": "欧布奥特曼·暗耀形态",
    "欧布暗耀形态": "欧布奥特曼·暗耀形态",
    ...
    "格罗布": "格罗布奥特曼",
    "令迦": "令迦奥特曼",
    "欧米伽雷基尼斯": "欧米伽奥特曼·雷基尼斯装甲",
    "雷基尼斯装甲": "欧米伽奥特曼·雷基尼斯装甲",
    "欧米伽特里加隆": "欧米伽奥特曼·特里加隆装甲",
    "特里加隆装甲": "欧米伽奥特曼·特里加隆装甲",
    "欧米伽瓦尔格尼斯": "欧米伽奥特曼·瓦尔格尼斯装甲",
    "瓦尔格尼斯装甲": "欧米伽奥特曼·瓦尔格尼斯装甲",
    "欧米伽盖梅顿": "欧米伽奥特曼·盖梅顿装甲",
    "盖梅顿装甲": "欧米伽奥特曼·盖梅顿装甲",
}
...
_FORM_VARIANTS = (
    ...
    ("欧布奥特曼·闪电攻击者", "ultraman-orb", 2017, "融合银河与艾克斯力量，以雷电、电子装甲和高速突击作战。", "两位数据时代战士的光在欧布身上交织成雷霆铠甲。"),
    ("欧布奥特曼·艾梅利姆头镖", "ultraman-orb", 2017, "融合赛文与赛罗力量，能驾驭三枚头镖进行立体斩击。", "父子两代的头镖绝技被红凯锤炼成攻防一体的锋刃。"),
    ...
    ("欧米伽奥特曼·雷基尼斯装甲", "ultraman-omega", 2025, "借助陨星怪兽雷基尼斯力量形成的电视强化装甲，配合雷基尼斯巨剑与念动力作战。", "在《欧米伽奥特曼》TV正剧中，雷基尼斯与欧米伽共鸣并化作装甲与武器。"),
    ("欧米伽奥特曼·特里加隆装甲", "ultraman-omega", 2025, "借助陨星怪兽特里加隆力量形成的高速近战装甲，以利爪和高机动性压制敌人。", "在《欧米伽奥特曼》TV正剧中，特里加隆与欧米伽共鸣后化作装甲与利爪。"),
    ("欧米伽奥特曼·瓦尔格尼斯装甲", "ultraman-omega", 2025, "借助陨星怪兽瓦尔格尼斯力量形成的元素型装甲，能够利用火、水、风、地等自然力量。", "在《欧米伽奥特曼》TV正剧后半段登场，瓦尔格尼斯化作装甲与长柄武装支援欧米伽。"),
    ("欧米伽奥特曼·盖梅顿装甲", "ultraman-omega", 2026, "借助盖梅顿力量形成的新装甲形态。", "在2026年TV节目《奥特曼新生代之星》中作为欧米伽的新装甲登场。"),
)
